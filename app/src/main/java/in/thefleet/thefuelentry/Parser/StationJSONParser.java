        ...
        if (content != null) {
            ...
            try {
                ...
                for (int i = 0; i < ar.length(); i++) {
                    ...
                    station.setRegularPetrol(obj.getDouble("RegularPetrol"));
                    station.setPremiumPetrol(obj.getDouble("PremiumPetrol"));
                    station.setRegularDiesel(obj.getDouble("RegularDiesel"));
                    station.setPremiumDiesel(obj.getDouble("PremiumDiesel"));
