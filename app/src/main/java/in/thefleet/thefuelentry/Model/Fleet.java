...
public class Fleet {
    ...
    private double Received_Milage;

    private double Fleet_Avg_Milage;

    private double LastQty;

    public double getReceived_Milage() {return Received_Milage;}

    public void setReceived_Milage(double received_Milage) {
        Received_Milage = received_Milage;
    }
